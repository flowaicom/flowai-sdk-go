...
func (s *Webhooks) Handle(ctx context.Context, svixID *string, svixTimestamp *string, svixSignature *string, opts ...operations.Option) (*operations.HandleClerkWebhookEndpointClerkWebhooksPostResponse, error) {
	request := operations.HandleClerkWebhookEndpointClerkWebhooksPostRequest{
		SvixID:        svixID,
	...
	opURL, err := url.JoinPath(baseURL, "/clerk-webhooks/")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "handle_clerk_webhook_endpoint_clerk_webhooks__post",
		OAuth2Scopes:     []string{},
		SecuritySource:   nil,
	}
	...
	res := &operations.HandleClerkWebhookEndpointClerkWebhooksPostResponse{
